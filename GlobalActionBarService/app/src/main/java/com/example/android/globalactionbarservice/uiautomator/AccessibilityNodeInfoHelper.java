package com.example.android.globalactionbarservice.uiautomator;
...
class AccessibilityNodeInfoHelper {
    ...
    static Rect getVisibleBoundsInScreen(AccessibilityNodeInfo node, int width, int height) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            AccessibilityWindowInfo window = com.example.android.globalactionbarservice.uiautomator.AccessibilityNodeInfoHelper.Api21Impl.getWindow(node);
            if (window != null) {
                com.example.android.globalactionbarservice.uiautomator.AccessibilityNodeInfoHelper.Api21Impl.getBoundsInScreen(window, bounds);
